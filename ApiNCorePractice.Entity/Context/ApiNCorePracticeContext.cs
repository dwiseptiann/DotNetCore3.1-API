...
namespace ApiNCorePractice.Entity.Context
{
    public partial class ApiNCorePracticeContext : DbContext
    {

        public ApiNCorePracticeContext(DbContextOptions<ApiNCorePracticeContext> options)
            : base(options)
        {
        }
