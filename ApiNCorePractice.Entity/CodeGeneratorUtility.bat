...
echo Delete previously generated cs code files 
 ...
 DEL /F "..\ApiNCorePractice.Domain\Domain\2_t4DomainViewModelsGenerate.cs"	
 ::DEL /F "..\ApiNCorePractice.Domain\Mapping\3_t4DomainMappingProfileGenerate.cs"	
 DEL /F "..\ApiNCorePractice.Domain\Service\4_t4DomainServicesGenerate.cs"	
 ::DEL /F "..\ApiNCorePractice.Api\Controllers\5_t4ApiControllerGenerate.cs"	
 ::DEL /F "..\ApiNCorePractice.Test\6_t4IntegrationTestGenerate.cs"
echo .
echo Run all T4s...
echo -generate entity helpers
%tt% "1_t4EntityHelpersGenerate.tt" -out "1_t4EntityHelpersGenerate.cs"
echo -generate domain classes
%tt% "..\ApiNCorePractice.Domain\Domain\2_t4DomainViewModelsGenerate.tt" -out "..\ApiNCorePractice.Domain\Domain\2_t4DomainViewModelsGenerate.cs"
echo -generate mapper classes
::%tt% "..\ApiNCorePractice.Domain\Mapping\3_t4DomainMappingProfileGenerate.tt" -out "..\ApiNCorePractice.Domain\Mapping\3_t4DomainMappingProfileGenerate.cs"	
echo -generate services classes
%tt% "..\ApiNCorePractice.Domain\Service\4_t4DomainServicesGenerate.tt" -out "..\ApiNCorePractice.Domain\Service\4_t4DomainServicesGenerate.cs"	
echo -generate controller classes
::%tt% "..\ApiNCorePractice.Api\Controllers\5_t4ApiControllerGenerate.tt" -out "..\ApiNCorePractice.Api\Controllers\5_t4ApiControllerGenerate.cs"	
echo -generate test classes
::%tt% "..\ApiNCorePractice.Test\6_t4IntegrationTestGenerate.tt" -out "..\ApiNCorePractice.Test\6_t4IntegrationTestGenerate.cs"	
echo T4s completed.
pause
:END