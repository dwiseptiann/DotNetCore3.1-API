...
namespace ApiNCorePractice.Entity.UnitofWork
{
    ...
    public interface IUnitOfWork : IDisposable
    {
        ...
        ApiNCorePracticeContext Context { get; }
        int Save();
        Task<int> SaveAsync();
    }
    ...
    {
        public ApiNCorePracticeContext Context { get; }

        private Dictionary<Type, object> _repositoriesAsync;
        private Dictionary<Type, object> _repositories;
        private bool _disposed;

        public UnitOfWork(ApiNCorePracticeContext context)
        {
            Context = context;
            _disposed = false;
        }
